package com.micky.kotlinproject.common.view.toast;
...
public class Toasty {
    ...
    @ColorInt
    private static int ERROR_COLOR = Color.parseColor("#C1D50000");
    @ColorInt
    private static int INFO_COLOR = Color.parseColor("#C1353A3E");
    @ColorInt
    private static int SUCCESS_COLOR = Color.parseColor("#C1108EE9");
    @ColorInt
    private static int WARNING_COLOR = Color.parseColor("#C1FFB244");
    @ColorInt
    private static int NORMAL_COLOR = Color.parseColor("#C1353A3E");

    private static final Typeface LOADED_TOAST_TYPEFACE = Typeface.create("sans-serif-condensed", Typeface.NORMAL);
    private static Typeface currentTypeface = LOADED_TOAST_TYPEFACE;
    private static int textSize = 16; // in DP
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ic_error_outline_white_48dp),
                NORMAL_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        toastTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, textSize);
    ...
    public static class Config {
        ...
        public static void reset() {
            ...
            Toasty.ERROR_COLOR = Color.parseColor("#C1D50000");
            Toasty.INFO_COLOR = Color.parseColor("#C1353A3E");
            Toasty.SUCCESS_COLOR = Color.parseColor("#C1108EE9");
            Toasty.WARNING_COLOR = Color.parseColor("#C1FFB244");
            Toasty.NORMAL_COLOR = Color.parseColor("C1353A3E");
        ...
        @CheckResult
        public Config setTextSize(int sizeInDp) {
